 ...
 * @author technowings
 */
public class PregnantWomenModel {
    String pwid, fname, mname, lname, dob, premonth, address, village, city, state, pincode, mobile, telno, email, adhar, bgrp, cdate, awcid;
