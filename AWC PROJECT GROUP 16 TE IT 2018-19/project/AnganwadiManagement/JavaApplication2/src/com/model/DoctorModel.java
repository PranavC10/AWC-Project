...
public class DoctorModel {
    String did, fname, mname, lname, gender, mstatus, dob, address, village, city, state, pincode, mobile, telno, email, education, year_of_passing10, year_of_passing12, skill, uname, password, awcid;
