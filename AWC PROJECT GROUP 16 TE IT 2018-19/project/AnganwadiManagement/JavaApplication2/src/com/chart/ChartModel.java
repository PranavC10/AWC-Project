...
public class ChartModel implements Serializable {
    ...
    String row1 = "1st Value", row2 = "2nd Value";
    String xAxisTitle = "X", yAxisTitle = "Y", graphTitle = "GraphTitle";
    Color chartBackground = Color.black;
    Color graphColor = Color.BLACK;
    Color colorTitle = Color.white;
    Color colorGrid = Color.green;
